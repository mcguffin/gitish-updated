...
You can can either go into the Support forum, or in the [Gitish Updated Repository](https://github.com//gitish-updated).

= I'd like to suggest a feature. Where should I post it? =

I personally prefer GitHub. The plugin code is here: [GitHub](https://github.com//gitish-updated)
(See above as well.)
...
3. type `git clone git@github.com:/gitish-updated.git`
...
Either post it on the [GitHub-repo](https://github.com//gitish-updated) or—if you cloned the repository—send me a pull request.
